    ...
    <div className="aoide">
      <div className="loader">
		...
		<main>
			...
			<a href="#ticket-wrap" className="ticket-link">
			...
			<div className="content">
				<nav className="menu">
					<a href="#" className="menu__item">summit<div className="empty-space">-</div>speakers</a>
					<a href="#" className="menu__item">schedule<div className="empty-space">-</div>&amp;<div className="empty-space">-</div>pass</a>
					<a href="#" className="menu__item">gallery<div className="empty-space">-</div>&amp;<div className="empty-space">-</div>sponsors</a>
					<a href="#" className="menu__item">latest<div className="empty-space">-</div>press</a>
					<a href="#" className="menu__item">stay<div className="empty-space">-</div>informed</a>
				</nav>
				<div className="event-time">
					<div className="section">
						<div className="hero-main-title">Bringing Leaders Together</div>
						<div className="hero-title">July 27</div>
						<div className="hero-subtitle"><span>2</span><span>0</span><span>1</span><span>9</span></div>
					</div>
				...
				<svg className="scene" width="1440" height="800" preserveAspectRatio="xMinYMid slice" viewBox="0 0 1440 800">
					<defs>
			...
			<div className="content content--reveal">
				<div className="content__inner">
					<div className="section full-height over-y-scroll" id="boxscroll-1">
						<div className="section" id="boxscroll-in-1">
								...
								<div className="container">
									<div className="row">
										<div className="col-md-12">
											<h2 className="content__title">summit speakers</h2>
										</div>
										<div className="col-lg-4 mt-3">
											<h3 className="content__subtitle">The rapid handle injects into the bashful lift.</h3>
										</div>
									</div>
								</div>
							</div>							
								...
								<div className="container">
									<div className="row">
										...
										<div className="col-md-9 mt-4 mt-md-0">
											...
											<p className="mt-4">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit.</p>
											<div className="social-team mt-4">
												<a href="#">tw</a>
												<a href="#">fb</a>
												<a href="#">be</a>
												<a href="#">in</a>
							...
							<div className="section padding-top padding-bottom-big background-dark footer">
								<div className="container">
									<div className="row">
										<div className="col-md-12">
											<img src="img/logo.png" alt="" />
										...
										<div className="col-md-12 mt-5 mb-5">
											<div className="title-page-line"></div>
										</div>
										<div className="col-md-12">
				...
				<div className="content__inner">
					<div className="section full-height over-y-scroll" id="boxscroll-2">
						<div className="section" id="boxscroll-in-2">
		
							<div className="section padding-top-big">
								<div className="container">
									<div className="row">
										<div className="col-md-12">
											<h2 className="content__title">schedule &amp; pass</h2>
										</div>
										<div className="col-lg-4 mt-3">
											<h3 className="content__subtitle">The rapid handle injects into the bashful lift.</h3>
										</div>
							...
							<div className="section padding-top-bottom">
								<div className="container">
									<div className="row">
										...
										<div className="col-md-3">
											<div className="schedule-time mb-4">
										...
										<div className="col-md-9 mt-4 mt-md-0">
											...
											<div className="section pl-5">
												<h6 className="mt-5 mb-3">welcome remarks by</h6>
										...
										<div className="offset-md-3 col-md-9 mt-5">
										...
										<div className="col-md-9 mt-4 mt-md-0">
											...
											<p><em>Hosted by some copmany</em></p>
											<div className="section pl-5">
												<h6 className="mt-5 mb-3">closing remarks by</h6>
												<p><strong>ANNA KULIS</strong> - Create a Database Cluster in the Cloud With MongoDB Atlas</p>
												<p><strong>MARCO FURIUS</strong> - Angular Authentication With JWT</p>
											</div>
										</div>		
									...
									<div className="row">
										...
										<div className="col-lg-9 mt-4 mt-lg-0">
											<div className="pass-wrap">
												<p className="pl-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
												<p className="mt-4"><em></em> seat in 7-10 row</p>
												<p className="mt-2"><em></em> free drink</p>
												<p className="mt-2"><em></em> event on flash drive</p>
												<p className="mt-2 mb-5 mb-sm-0"><em className="no"></em> speakers support</p>
										...
										<div className="col-lg-9 mt-4 mt-lg-5">
											<div className="pass-wrap">
												<p className="pl-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
												<p className="mt-4"><em></em> seat in 5-7 row</p>
												<p className="mt-2"><em></em> 3 free drinks</p>
												<p className="mt-2"><em></em> event on flash drive</p>
												<p className="mt-2 mb-5 mb-sm-0"><em className="no"></em> speakers support</p>
												<a href="#" className="btn-pass-2">get ticket - $70</a>
											</div>		
										</div>								
										<div className="col-lg-3 mt-5">
										...
										<div className="col-lg-9 mt-4 mt-lg-5">
											<div className="pass-wrap">
												<p className="pl-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
												<p className="mt-4"><em></em> seat in 3-5 row</p>
												<p className="mt-2"><em></em> 5 free drinks</p>
												<p className="mt-2"><em></em> event on flash drive</p>
												<p className="mt-2 mb-5 mb-sm-0"><em className="no"></em> speakers support</p>
												<a href="#" className="btn-pass-3">get ticket - $100</a>
											</div>
										</div>								
										<div className="col-lg-3 mt-5">
										...
										<div className="col-lg-9 mt-4 mt-lg-5">
											<div className="pass-wrap">
												<p className="pl-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
												<p className="mt-4"><em></em> seat in 1-3 row</p>
												<p className="mt-2"><em></em> 10 free drinks</p>
												<p className="mt-2"><em></em> event on flash drive</p>
												<p className="mt-2 mb-5 mb-sm-0"><em></em> speakers support</p>
												<a href="#" className="btn-pass-4">get ticket - $125</a>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="content__inner">
					<div className="section full-height over-y-scroll" id="boxscroll-3">
						<div className="section" id="boxscroll-in-3">
							<div className="section padding-top-big">
								<div className="container">
									<div className="row">
										<div className="col-md-12">
											<h2 className="content__title">gallery &amp; sponsors</h2>
										</div>
										<div className="col-lg-4 mt-3">
											<h3 className="content__subtitle">The rapid handle injects into the bashful lift.</h3>
										</div>
				...
				<div className="content__inner">
					<div className="section full-height over-y-scroll" id="boxscroll-4">
						<div className="section" id="boxscroll-in-4">
							<div className="section padding-top-big">
								<div className="container">
									<div className="row">
										<div className="col-md-12">
											<h2 className="content__title">latest press</h2>
										</div>
										<div className="col-lg-4 mt-3">
											<h3 className="content__subtitle">The rapid handle injects into the bashful lift.</h3>
										</div>
							...
							<div className="section padding-top padding-bottom-big">
								<div className="container">
									<div className="row">
										<div className="col-md-4">
											<div className="blog-wrap pb-4">
												...
												<a href="#"><div className="go-post pl-4 pt-4"><i className="fa fa-long-arrow-right"></i></div></a>
											</div>
										</div>
				...
				<div className="content__inner">
					<div className="section full-height over-y-scroll" id="boxscroll-5">
						<div className="section" id="boxscroll-in-5">

							<div className="section padding-top-big">
								<div className="container">
									<div className="row">
										<div className="col-md-12">
											<h2 className="content__title">stay informed</h2>
										</div>
										<div className="col-lg-4 mt-3">
											<h3 className="content__subtitle">The rapid handle injects into the bashful lift.</h3>
										</div>
									...
									<div className="row">		
										...
										<div className="col-lg-9 mt-4 mt-lg-0">
											<form name="ajax-form" id="ajax-form" action="mail-it.php" method="post">
												<div className="row">
													...
													<div className="col-lg-12 mt-4">
														<div id="button-con"><button className="send_message" id="send" data-lang="en"><span>submit</span></button></div>					
													</div>	
													<div className="col-lg-12">
														<div className="error" id="err-form"><span>There was a problem validating the form please check!</span></div>
										...
										<div className="col-lg-9 mt-4 mt-lg-5">
											<div className="subscribe">
												...
												<button data-lang="en"><span className="fa-long-arrow-right"></span></button>
											</div>
				...
				<button className="content__close"></button>
			</div>
